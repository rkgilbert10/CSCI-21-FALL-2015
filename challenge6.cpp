 ...
 * Notes:
 * Sources used: http://www.cplusplus.com/forum/beginner/62390/
 */
#include <cassert>
#include <iostream>
#include <sstream>
 ...
 * does not check the validity of the two indices -- the function assumes 
 * the caller passes valid indices for the array.
 * @param values an integer array
